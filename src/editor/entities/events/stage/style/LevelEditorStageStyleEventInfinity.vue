...
const props = defineProps<{
    range: Range<StageStyleEventJointEntity>
}>()

const xMin = computed(() => props.range.min.editorLane)
const xMax = computed(() => props.range.max.editorLane)
...
<template>
    <g v-if="range" stroke="#0ff" stroke-opacity="0.5">
