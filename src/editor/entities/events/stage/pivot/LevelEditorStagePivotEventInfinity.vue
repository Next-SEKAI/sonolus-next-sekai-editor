...
const props = defineProps<{
    range: Range<StagePivotEventJointEntity>
}>()

const xMin = computed(() => props.range.min.pivotLane)
const xMax = computed(() => props.range.max.pivotLane)
...
<template>
    <g v-if="range" stroke="#00f" stroke-opacity="0.5">
