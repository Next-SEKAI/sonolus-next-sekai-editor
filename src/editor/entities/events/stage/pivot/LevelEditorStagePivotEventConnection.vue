...
import type { StagePivotEventConnectionEntity } from '../../../../../state/entities/events/connections/stage/pivot'
import { beatToTime } from '../../../../../state/integrals/bpms'
import { ups } from '../../../../view'
import { getPathD } from '../../path'

const props = defineProps<{
    entity: StagePivotEventConnectionEntity
...
const d = computed(() => {
    ...
    return getPathD(min.pivotLane, max.pivotLane, yMin, yMax, min.eventEase)
})
</script>
